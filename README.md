...
To quantify the performance improvements of this scheduler over naive implementations, we gathered the following baseline comparisons natively on the host CPU:

| Optimization Area | Technique Applied | Baseline | Optimized | Gain | Benchmark |
| :--- | :--- | :--- | :--- | :--- | :--- |
